...
public class GameField : OCGobject
{
    ...
    public GameField()
    {
        ...
        LOCATION_DECK_0 = create(Program.I().new_ui_textMesh, Vector3.zero, new Vector3(60, 0, 0))
            .GetComponent<TextMeshPro>();
        LOCATION_EXTRA_0 = create(Program.I().new_ui_textMesh, Vector3.zero, new Vector3(60, 0, 0))
            .GetComponent<TextMeshPro>();
        LOCATION_GRAVE_0 = create(Program.I().new_ui_textMesh, Vector3.zero, new Vector3(60, 0, 0))
            .GetComponent<TextMeshPro>();
        LOCATION_REMOVED_0 = create(Program.I().new_ui_textMesh, Vector3.zero, new Vector3(60, 0, 0))
            .GetComponent<TextMeshPro>();


        LOCATION_DECK_1 = create(Program.I().new_ui_textMesh, Vector3.zero, new Vector3(60, 0, 0))
            .GetComponent<TextMeshPro>();
        LOCATION_EXTRA_1 = create(Program.I().new_ui_textMesh, Vector3.zero, new Vector3(60, 0, 0))
            .GetComponent<TextMeshPro>();
        LOCATION_GRAVE_1 = create(Program.I().new_ui_textMesh, Vector3.zero, new Vector3(60, 0, 0))
            .GetComponent<TextMeshPro>();
        LOCATION_REMOVED_1 = create(Program.I().new_ui_textMesh, Vector3.zero, new Vector3(60, 0, 0))
            .GetComponent<TextMeshPro>();
